...
(function(exports) {
    ...
    (function() {
        ...
        exports.define('require', function() { return define; });
...
function define(moduleId, dependencies, definition) {
    if (arguments.length == 3) {
        Modules.defineWithDependencies(moduleId, dependencies, definition);
    } else if (arguments.length == 2) {
        Modules.define(moduleId, dependencies);
    } else {
...
function require(dependencies, callback) {
    return Modules.uses(dependencies, callback);
}